...
export const siteContent = {
  ...
  hero: {
    title: "حوّل مساحتك",
    subtitle:
      "المُخْتَار… حيث يلتقي الذوق الرفيع مع جودة الأثاث",
    buttons: {
  ...
  about: {
    title: "من نحن",
    description1:
      "المُخْتَار فريق متخصص في تقديم أجمل حلول الأثاث والتصاميم المنزلية، نحن نجمع بين الجودة و الأناقة و الأسعار المناسبة لأثاث منزلك",
    description2:
      "هدفنا هو تمكينك من تصميم منزل أحلامك بقطع أثاث تعبر عن ذوقك الرفيع",
    mission: {
      title: "رسالتنا",
      description:
        "تصميم وتقديم أثاث يمزج بسلاسة بين الجمال و الابداع والاستدامة، مما تميز حياة عملائنا ومساحاتهم.",
    },
    vision: {
      title: "رؤيتنا",
      description:
